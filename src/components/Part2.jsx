...
function Part2({ isOpen, toggleAccordion }) {
  return (
    <>
      <div className=" flex justify-between px-4 mt-4">
        <div>
          <p className="text-[#17384D]">PART 2</p>
          <p className="font-bold">Binary Search Tree</p>
        </div>
      ...
      <div className="flex justify-end px-4 my-[6px]">
        <div className="rounded-lg border-[1px] border-[#a4e6ff] p-1 bg-[#EFF5FF]">
          <p className="text-black text-sm">20% Completed</p>
        </div>
      </div>

      {/* Progress Bar */}
      <div className="flex">
        <div className="w-[20%] bg-[#172B4D] h-[6px] rounded-bl-2xl"></div>
        <div className="w-[80%] bg-[#EFF5FF] h-[6px] rounded-br-2xl"></div>
      </div>
    </>
  );
}
